...
class SearchLPIS(object):
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Wyszukiwarka LPIS')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'SearchLPIS')
        self.toolbar.setObjectName(u'SearchLPIS')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SearchLPIS', message)
